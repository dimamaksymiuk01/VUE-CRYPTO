...
export default {
  ...
  methods: {
    add() {
      ...
      setInterval(async () => {
        const f = await  fetch(`https://min-api.cryptocompare.com/data/price?fsym=${currentTicker.name}&tsyms=USD&api_key=234a1b0991c01bb3e4fd9f05da4052e50ebcc965d750429ef189961cfedaa6e3`)
